      ...
      >
        ...
        <div className="rounded-3xl border border-white/5 bg-white/5 p-8 backdrop-blur-2xl shadow-2xl">
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            {}
            <button className="group relative mt-4 flex w-full items-center justify-center gap-3 rounded-xl bg-violet-600 py-4 font-black uppercase tracking-widest text-white transition-all hover:bg-violet-500 active:scale-95 shadow-xl shadow-violet-600/20">
              Initialize Access 
